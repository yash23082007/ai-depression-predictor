    ...
    return (
        <header className="bg-stone-50/80 backdrop-blur-lg sticky top-0 z-40 border-b border-stone-200">
            <div className="container mx-auto px-6 py-5 flex justify-between items-center max-w-5xl">
                <Link to="/" className="flex items-center space-x-3 text-stone-900 group">
                    <div className="w-10 h-10 flex items-center justify-center text-stone-900 group-hover:text-sage-600 transition-colors duration-500">
